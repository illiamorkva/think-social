...
class User
{
    ...
    public static function register($name, $email, $password)
    {
        ...
        $sql = 'INSERT INTO users (first_name, middle_name, last_name, email, birthday, sex) '
            . 'VALUES (:first_name, "middle_name", "last_name", :email, "birthday", "male");'
			. 'INSERT INTO passwords (user_id, password)'
			. 'VALUES(LAST_INSERT_ID(),:password)';
			
        $result = $db->prepare($sql);
        $result->bindParam(':first_name', $name, PDO::PARAM_STR);
		//$result->bindParam(':middle_name', 'temporary_middle_name', PDO::PARAM_STR);
		//$result->bindParam(':last_name', 'temporary_last_name', PDO::PARAM_STR);
        $result->bindParam(':email', $email, PDO::PARAM_STR);
		//$result->bindParam(':birthday', 'temporary_birthday', PDO::PARAM_STR);
